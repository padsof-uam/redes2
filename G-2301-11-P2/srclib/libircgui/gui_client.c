...
void setTopicProtect    (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(topicB)     , state);
}
void setExternMsg   (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(externB)    , state);
}
void setSecret      (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(secretB)    , state);
}
void setGuests      (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(guestB)     , state);
}
void setPrivate     (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(privateB)   , state);
}
void setModerated   (gboolean state)
{
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(moderatedB) , state);
}
