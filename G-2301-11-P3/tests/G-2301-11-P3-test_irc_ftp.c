...
/**
 * Genera datos aleatorios de longitud len.
 * @param  len Longitud de los datos a generar.
 * @return     String con datos aleatorios.
 */
...
/* BEGIN TESTS */
 int t_irc_ftp__transfer_something__timeout() {
	...
	/* Mensaje inicial de comunicación (tamaño total del fichero) */
